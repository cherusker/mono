...
static gint32 trampoline_calls, jit_trampolines, unbox_trampolines, static_rgctx_trampolines, rgctx_unmanaged_lookups, rgctx_num_lazy_fetch_trampolines;
...
mono_create_rgctx_lazy_fetch_trampoline (guint32 offset)
{
	...
	InterlockedIncrement (&rgctx_num_lazy_fetch_trampolines);
